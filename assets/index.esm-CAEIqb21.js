import{u as _,b as $,j as C,D as qe,N as xt,E as U}from"./index-o0Cm9TaK.js";import{I as mt}from"./Filter.styled-DsAjYpvh.js";const vt="/petlove/shape_bcgr_mob1.png",bt="/petlove/shape_bcgr_tab1.png",_t="/petlove/shape_bcgr_desk1.png",wt=_.div`
    width: 335px;
    height: 280px;
    border-radius: 30px;
...
`,fr=({children:e})=>C.jsxs(wt,{children:[C.jsx(kt,{}),C.jsx(Ft,{children:e})]}),Vt="/petlove/images/dog_hero_mob_x1.png",At="/petlove/images/dog_hero_mob_x2.png",Dt="/petlove/images/dog_hero_tabx1.png",Et="/petlove/images/dog_hero_tabx2.png",$t="/petlove/images/dog_hero_desk_x1.png",St="/petlove/images/dog_hero_desk_x2.png",gr=_.div`
    display: flex;
...
`,pr=({avatarSrc:e,avatarSrc2x:i,title:r,birthDate:o,description:l})=>C.jsxs(Tt,{children:[C.jsx(Lt,{children:C.jsx(Ct,{$avatarSrc:e,$avatarSrc2x:i,alt:"Hero Avatar"})}),C.jsxs(zt,{children:[C.jsxs(Bt,{children:[C.jsx(Ot,{children:r}),C.jsxs(Rt,{children:[C.jsx(It,{children:"Birthday: "}),C.jsx(Mt,{children:o})]})]}),C.jsx(Ut,{children:l})]})]}),Nt=_.h1`
    margin-bottom: 12px;
...
`,yr=({text:e,color:i})=>C.jsx(Nt,{color:i,children:e}),xr=_.div`
    padding: 55px 20px;
