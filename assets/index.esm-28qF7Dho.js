import{u as T,b as Z,j as $,R as M}from"./index-Cge4GHqC.js";const xr="/petlove/shape_bcgr_mob1.png",vr="/petlove/shape_bcgr_tab1.png",pr="/petlove/shape_bcgr_desk1.png",br=T.div`
    width: 335px;
    height: 280px;
    border-radius: 30px;
    ...
    @media only screen and (min-width: ${Z.medium}) {
        width: 704px;
        height: 302px;
    ...
    @media only screen and (min-width: ${Z.large}) {
        margin-left: -32px;
        width: 590px;
        height: 654px;
    }
